...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleConflict(RestException ex, WebRequest request) {
		String bodyOfResponse = ex.getSimpleName() + " caused by " + ex.getMessage();
		HttpHeaders responseHeaders = new HttpHeaders();
		responseHeaders.set(RestException.HEADER_ERROR_NAME, ex.getSimpleName());
		responseHeaders.set(RestException.HEADER_ERROR_MESSAGE, ex.getMessage());
